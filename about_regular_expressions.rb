...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #  --> Not too sure I understood the questin. "Fail" as in raise an error ? 
    #  Fail as "won't match" ? On its own : it should not fail.
    #  More than ever / less than always ?
  end
  ...
  #
  # Why?
  # Greedy : trying to get as much result as possible.
  # non-greedy : trying to get as little results as possible.
